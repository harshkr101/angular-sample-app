...
export const DISHES: Dish[] = [
    ...
    },
    {
        ...
        label: '',
        price: '6.99',
        description: 'Well garnished italian  pasta ',
        comments: [
            {
                rating: 5,
                comment: 'Imagine all the eatables, living in conFusion!',
    ...
    },
    {
        ...
        label: 'New',
        price: '3.99',
        description: 'Best American donuts you get in world',
        comments: [
            {
                rating: 5,
                comment: 'Imagine all the eatables, living in conFusion!',
    ...
    },
    {
        ...
        label: '',
        price: '3.99',
        description: 'A delectable, sweet New York Style Choclate Pastry',
        comments: [
            {
                rating: 5,
                comment: 'Imagine all the eatables, living in conFusion!',
